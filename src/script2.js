...
var createScene = function(){
    ...
    scene.registerAfterRender(function () {
        ...
        if ((map["q"] || map["Q"])) {
            ...
            tankTower.addRotation(0,-0.05,0);
        };
        if ((map["e"] || map["E"])) {
    ...
    //     tankTower.rotation = new BABYLON.Vector3(0,vectorX/100,0);
    //     // tankTower.addRotation(0,parseFloat(Math.sin(scene.pointerX)),0)
